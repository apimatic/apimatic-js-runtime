...
function expectMatchingWithOptions(expected, actual, options) {
  ...
  var _a = options.isOrdered,
    isOrdered = _a === void 0 ? false : _a,
    _b = options.checkValues,
    checkValues = _b === void 0 ? false : _b,
    _c = options.allowExtra,
    allowExtra = _c === void 0 ? false : _c;
...
function checkArrays(left, right, isOrdered) {
  ...
  left.forEach(function (leftVal) {
    return expect(right).toContainEqual(leftVal);
  });
}
...
export { expectHeadersToMatch, expectMatchingWithOptions };