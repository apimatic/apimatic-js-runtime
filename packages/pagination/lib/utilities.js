...
exports.getValueByJsonPointer = exports.extractQueryParams = void 0;
var tslib_1 = require("tslib");
function extractQueryParams(link) {
    var e_1, _a;
    var result = {};
    var _b = tslib_1.__read(link.split('?'), 2), query = _b[1];
    var decodedEqualsQuery = decodeURIComponent(query);
    var queryParams = decodedEqualsQuery.split('&');
    var _loop_1 = function (queryParam) {
        var _c = tslib_1.__read(queryParam.split('='), 2), key = _c[0], value = _c[1];
        if (key) {
            var queryPointer = '$request.query#/' + decodeURIComponent(key);
            result[queryPointer] = function () { return decodeURIComponent(value || ''); };
        }
    };
    try {
        for (var queryParams_1 = tslib_1.__values(queryParams), queryParams_1_1 = queryParams_1.next(); !queryParams_1_1.done; queryParams_1_1 = queryParams_1.next()) {
...
function getValueByJsonPointer(response, pointer) {
    var _a = tslib_1.__read(pointer.split('#'), 2), prefix = _a[0], jsonPath = _a[1];
...
exports.getValueByJsonPointer = getValueByJsonPointer;
