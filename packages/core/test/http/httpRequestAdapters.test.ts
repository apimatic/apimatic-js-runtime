...
describe('convertExpressRequest', () => {
    ...
    it('should throw for invalid HTTP method', () => {
        ...
        expect(() => convertExpressRequest(req)).toThrow('Invalid HTTP method: INVALID');
    });

    it('should throw for invalid URL', () => {
        const req = { ...baseReq, method: 'GET', protocol: 'http', get: () => ':::::', originalUrl: ':::::', body: undefined };
    ...
    it('should handle object body', () => {
        ...
        const result = convertExpressRequest(req);
        expect(result.body).toEqual({ type: 'text', content: JSON.stringify({ foo: 'bar' }) });
    });
    ...
    it('should throw if method is undefined', () => {
        ...
        expect(() => convertExpressRequest(req)).toThrow('Invalid HTTP method: undefined');
    });
